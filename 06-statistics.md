...
>> P(identical twins & twin brother) = P(identical twins) P(Both Boys| identical twins) =1/(300*2)


>> P(fraternal twins & twin brother) = P(fraternal twins) P(both boys | fraternal twins) = 1/(125*4)
...
>> The  frequentist approach focuses on the probability of the data, given the hypothesis. 
